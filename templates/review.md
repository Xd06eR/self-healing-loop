...
3. Test honesty: does the new/updated test actually exercise the original failure, or does it pass trivially regardless of whether the bug is fixed?
...
- reason: one paragraph, specific to what you checked. "Looks fine" is not a reason.
